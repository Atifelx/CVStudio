...
import { Mail, Phone, Linkedin, Github, Plus, User } from 'lucide-react';
 ...
 * Handles empty state with edit prompt
 */
export default function HeaderSection() {
  ...
  if (isEmpty) {
    return (
      <div 
        onClick={handleEdit}
        className="bg-gradient-to-r from-blue-900 to-blue-700 text-white p-8 cursor-pointer hover:from-blue-800 hover:to-blue-600 transition-all"
      >
        <div className="text-center">
          ...
          <p className="text-blue-200 text-sm">Click to add your name, title, and contact details</p>
        </div>
      </div>
    );
  }
